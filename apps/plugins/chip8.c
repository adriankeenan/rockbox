...
#define CHIP8_KEY7 BUTTON_B
#define CHIP8_KEY8 BUTTON_DOWN
#define CHIP8_KEY9 BUTTON_R1
#define CHIP8_KEY0 BUTTON_L1

#elif CONFIG_KEYPAD == PSP_PAD
#define CHIP8_OFF  BUTTON_START
#define CHIP8_KEY1 BUTTON_SQUARE
#define CHIP8_KEY2 BUTTON_CROSS
#define CHIP8_KEY3 BUTTON_TRIANGLE
#define CHIP8_KEY4 BUTTON_LEFT
#define CHIP8_KEY5 BUTTON_UP
#define CHIP8_KEY6 BUTTON_RIGHT
#define CHIP8_KEY7 BUTTON_CIRCLE
#define CHIP8_KEY8 BUTTON_DOWN
#define CHIP8_KEY9 BUTTON_R
#define CHIP8_KEY0 BUTTON_L
