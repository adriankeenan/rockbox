...
#define FLIPIT_UP           BUTTON_UP
#define FLIPIT_DOWN         BUTTON_DOWN
#define FLIPIT_NEXT         BUTTON_R1
#define FLIPIT_PREV         BUTTON_L1
#define FLIPIT_QUIT         BUTTON_START
#define FLIPIT_SHUFFLE      BUTTON_B
#define FLIPIT_SOLVE        BUTTON_X
#define FLIPIT_STEP_BY_STEP BUTTON_Y
...
#define FLIPIT_PREV         BUTTON_L
#define FLIPIT_QUIT         BUTTON_START
#define FLIPIT_SHUFFLE      BUTTON_CIRCLE
#define FLIPIT_SOLVE        BUTTON_TRIANGLE
#define FLIPIT_STEP_BY_STEP BUTTON_SQUARE
#define FLIPIT_TOGGLE       BUTTON_CROSS
