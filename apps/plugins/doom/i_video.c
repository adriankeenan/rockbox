...
#define DOOMBUTTON_LEFT    BUTTON_LEFT
#define DOOMBUTTON_RIGHT   BUTTON_RIGHT
#define DOOMBUTTON_SHOOT   BUTTON_R1
#define DOOMBUTTON_OPEN    BUTTON_B
#define DOOMBUTTON_ESC     BUTTON_START
#define DOOMBUTTON_ENTER   BUTTON_A
#define DOOMBUTTON_WEAPON  BUTTON_X
...
#define DOOMBUTTON_RIGHT   BUTTON_RIGHT
#define DOOMBUTTON_SHOOT   BUTTON_R
#define DOOMBUTTON_OPEN    BUTTON_CIRCLE
#define DOOMBUTTON_ESC     BUTTON_START
#define DOOMBUTTON_ENTER   BUTTON_CROSS
#define DOOMBUTTON_WEAPON  BUTTON_TRIANGLE
#define DOOMBUTTON_MAP     BUTTON_SQUARE
