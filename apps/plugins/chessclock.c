...
#define CHC_QUIT            BUTTON_START
#define CHC_STARTSTOP       BUTTON_CROSS
#define CHC_RESET           BUTTON_TRIANGLE
#define CHC_MENU            BUTTON_CIRCLE
#define CHC_SETTINGS_INC    BUTTON_UP
#define CHC_SETTINGS_DEC    BUTTON_DOWN
#define CHC_SETTINGS_OK     BUTTON_CROSS
#define CHC_SETTINGS_CANCEL BUTTON_CIRCLE
