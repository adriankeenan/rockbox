...
#define ROCKBLOX_OFF           BUTTON_START
#define ROCKBLOX_ROTATE_CCW    BUTTON_TRIANGLE
#define ROCKBLOX_ROTATE_CW     BUTTON_SQUARE
#define ROCKBLOX_ROTATE        BUTTON_UP
#define ROCKBLOX_DOWN          BUTTON_DOWN
#define ROCKBLOX_LEFT          BUTTON_LEFT
#define ROCKBLOX_RIGHT         BUTTON_RIGHT
#define ROCKBLOX_DROP          BUTTON_CROSS
#define ROCKBLOX_RESTART       BUTTON_CIRCLE
