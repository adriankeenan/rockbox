...
/* Button Code Definitions for the Anbernic RG35XX Pro */
...
static const struct button_mapping button_context_wps[]  = {
    ...
    { ACTION_WPS_HOTKEY,            BUTTON_L1|BUTTON_REL,           BUTTON_L1 },
    { ACTION_WPS_QUICKSCREEN,       BUTTON_R1|BUTTON_REL,           BUTTON_R1 },
    { ACTION_WPS_PITCHSCREEN,       BUTTON_R1|BUTTON_REPEAT,        BUTTON_NONE },
...
static const struct button_mapping button_context_tree[]  = {
    ...
    { ACTION_TREE_HOTKEY, BUTTON_L1|BUTTON_REL,     BUTTON_L1 },
    { ACTION_TREE_STOP,   BUTTON_L1|BUTTON_REPEAT,  BUTTON_NONE },
...
static const struct button_mapping button_context_keyboard[]  = {
    ...
    { ACTION_KBD_CURSOR_LEFT,  BUTTON_L1,                      BUTTON_NONE },
    { ACTION_KBD_CURSOR_LEFT,  BUTTON_L1|BUTTON_REPEAT,        BUTTON_NONE },
    { ACTION_KBD_CURSOR_RIGHT, BUTTON_R1,                      BUTTON_NONE },
    { ACTION_KBD_CURSOR_RIGHT, BUTTON_R1|BUTTON_REPEAT,        BUTTON_NONE },
