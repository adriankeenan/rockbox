...
\nopt{sansa,fuzeplus,rgnano,rg35xxpro}%will probably be there on Sansas one day -  exclude it the simple way without specific option
{\nopt{sansaAMS}{
  \subsection{Battery}
...
% Every entry below is conditional, so on targets with no USB options at all
% (USB_NONE) the description would otherwise render empty and error out.
\opt{usb_hid,usb_power,multidrive_usb}{
\subsection{USB}
