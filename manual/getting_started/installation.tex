...
\opt{ipod1g2g}{
  ...
  connect it to your computer. \nopt{rgnano,rg35xxpro}{For manual installation/uninstallation, or
...
\opt{rg35xxpro}{
  Rockbox runs as a ``port'' on top of the KNULLI custom firmware, so your
  \dap{} needs to be running KNULLI before installing Rockbox. If you have not
  installed it yet, follow the instructions for your device at
  \url{https://knulli.org/}.

  Rockbox does not replace KNULLI and does not modify it in any way. It is
  launched from, and returns to, the KNULLI game menu just like any other port.
}
...
\opt{gigabeats,fiiom3k,shanlingq1}{
  ...
  \opt{rgnano,rg35xxpro}{There is one main component which needs to be
...
\opt{rg35xxpro}{
\item[The Rockbox application.]
All of the Rockbox code is contained in a \fname{rockbox} directory, alongside
  a \fname{rockbox.sh} launcher script that KNULLI uses to start it. Both live
  in the \fname{roms/ports} folder of your \daps{} share partition, so
  updating Rockbox is a matter of replacing that directory.
}
\end{description}
...
\nopt{rgnano,rg35xxpro}{\subsubsection{Installing the firmware}\label{sec:installing_firmware}}
\opt{rgnano,rg35xxpro}{\subsubsection{Installing the application}\label{sec:installing_firmware}}
...
\item Take the \fname{.zip} file that you downloaded and use
 ...
 \opt{rg35xxpro}{the \fname{roms} folder of the share partition of }%
 your \dap{}.
...
\opt{swcodec}{%
    \nopt{gigabeats,erosqnative,rgnano,rg35xxpro}{%
...
\opt{gigabeats,rgnano,rg35xxpro}{
...
\nopt{ipod,gigabeats,cowond2,rgnano,rg35xxpro}{When
...
\opt{rg35xxpro}{
  Start Rockbox from the \fname{Ports} collection in the KNULLI game menu.
  Quitting Rockbox returns you to it.
}
...
\nopt{erosqnative,rgnano,rg35xxpro}{
...
\opt{rg35xxpro}{
  Rockbox is updated by extracting a newer \fname{.zip} over the
  \fname{roms} folder of the share partition, overwriting the existing
  \fname{ports/rockbox} directory. Your settings are kept, as they are stored
  in \fname{ports/rockbox/.rockbox/config.cfg}.
}

\section{Uninstalling Rockbox}\index{Installation!uninstall}

\nopt{gigabeatf,iaudiom3,iaudiom5,iaudiox5,mrobe100,gigabeats,fuzeplus,erosqnative,rgnano,rg35xxpro}{
...
\opt{rg35xxpro}{
  You can uninstall Rockbox simply by removing:
  \begin{itemize}
  \item The \fname{roms/ports/rockbox.sh} file.
  \item The \fname{roms/ports/rockbox} folder.
  \end{itemize}
  from the share partition of your \dap{}. KNULLI itself is left untouched.
}
...
\nopt{rgnano,rg35xxpro}{
  ...
  \opt{iriverh100,iriverh300,mpiohd200}{\item[``$-1$ error'']}
    If you receive a
    \nopt{iriverh100,iriverh300,mpiohd200,rgnano,rg35xxpro}{``File Not Found''}
...
\opt{rg35xxpro}{
  \item [Rockbox doesn't show up under Ports.]
  Check that \fname{roms/ports/rockbox.sh} and \fname{roms/ports/rockbox} were
  both extracted, and that the launcher script and the \fname{rockbox} binary
  inside the directory are both executable. Then refresh the game list from the
  KNULLI menu, or restart the \dap{}.
}
